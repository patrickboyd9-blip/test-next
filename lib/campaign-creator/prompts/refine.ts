...
- Change only what the customer asked for. Preserve everything else, including leadJob, imageryRole, typeRole, and imagePresence unless the request changes the creative concept
